[<img src="https://fusioncharts.github.io/react-fusioncharts-component/static/media/fc-logo.d427d93d.svg" width="234px" alt="FusionCharts - Build beautiful web & mobile dashboards">](https://www.fusioncharts.com/)
...
### What's New:
#### FusionCharts
* :new: Added **4** new scroll charts:
  * :bar_chart: Grouped bar with scrolling - `scrollbar2d`
  * :bar_chart: Stacked bars with scrolling - `scrollstackedbar2d`
  * :bar_chart: Grouped stacked columns with scrolling - `scrollmsstackedcolumn2d`
  * :bar_chart: Dual axis - Grouped stacked columns & line with scrolling - `scrollmsstackedcolumn2dlinedy`
* :new: Added **3** new combination charts:
  * :bar_chart: Dual axis - Stacked columns & line - `stackedcolumn2dlinedy`
  * :bar_chart: Dual axis - Stacked area & line - `stackedarea2dlinedy`
  * :bar_chart: Dual axis - Column, line & area, in 3D - `mscombidy3d`
* :hammer_and_wrench: Added support to export chart as CSV data from chart's export menu.
* :capital_abcd: Added Data plot value text cosmetics options.
* :triangular_ruler: Added support for customizing white space around canvas with canvas padding attributes.
* :hammer_and_wrench: Improved DOM elements order to adhere better with the accessibility guidelines.
* :straight_ruler: Added support to reverse scale in Horizontal Linear gauge.
* :hammer_and_wrench: Improved data plot API events.

#### FusionTime
* :new: API methods and events for FusionTime are now available.
* :new: Data markers are now supported in stock charts.
* :hammer_and_wrench: Introduced formatting options for Y-Axis values.
* :triangular_ruler: Added support for grid band on Y-Axis.
* :hammer_and_wrench: Improved behaviors for reference zone, SRS, data and time markers, and few other elements.
